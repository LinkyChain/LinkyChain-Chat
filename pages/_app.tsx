...
const formatCountdown = (seconds: number) => {
  ...
  const generateUserName = () => {
    const adjectives = ['Curious', 'Silent', 'Digital', 'Wise', 'Green', 'Mystic', 'Swift', 'Bright', 'Quantum', 'Cosmic', 'Stellar', 'Deep', 'Ancient', 'Reflective', 'Ethereal', 'Shining', 'Azure', 'Icy', 'Flaming', 'Electric', 'Immortal', 'Spherical', 'Subtle', 'Interstellar', 'Hypnotic', 'Royal', 'Fictional', 'Spectral', 'Magnetic', 'Kinetic', 'Synchronous', 'Paradoxical', 'Unreal', 'Oneiric', 'Untimely', 'Transcendent', 'Infinite', 'Geometric', 'Symbiotic', 'Galactic', 'Primary', 'Secondary', 'Ultraviolet', 'Invisible', 'Hidden', 'Fugitive', 'Abyssal', 'Celestial', 'Sacred', 'Profane', 'Esoteric', 'Alchemical', 'Mechanical', 'Organic', 'Virtual', 'Replicated', 'Fragmented', 'Integral', 'Solitary', 'Collective', 'Absolute', 'Relative', 'Circular', 'Rectilinear', 'Horizontal', 'Vertical', 'Three-dimensional', 'Two-dimensional', 'Floating', 'Eternal', 'Momentary', 'Continuous', 'Discrete', 'Incessant', 'Unstable', 'Stable', 'Vibrant', 'Resonant', 'Harmonic', 'Chaotic', 'Anarchic', 'Monolithic', 'Polymorphic', 'Mutant', 'Evolutionary', 'Stationary', 'Immobile', 'Dynamic', 'Static', 'Incorporeal', 'Material', 'Substantial', 'Inconsistent', 'Fluid', 'Viscous', 'Solid', 'Gaseous', 'Limpid', 'Opaque', 'Transparent', 'Crystalline', 'Phosphorescent',];
    const nouns = ['Voyager', 'Phantom', 'Echo', 'Nexus', 'Stream', 'Pixel', 'Orb', 'Drifter', 'Byte', 'Glitch', 'Cipher', 'Vortex', 'Golem', 'Aether', 'Fragment', 'Relic', 'Monolith', 'Chronomancer', 'Dream', 'Shadow', 'Residue', 'Sentinel', 'Automaton', 'Oracle', 'Simulacrum', 'Enigma', 'Ring', 'Grid', 'Aura', 'Cryptogram', 'Archive', 'Memory', 'Spirit', 'Avatar', 'Entity', 'Archetype', 'Scheme', 'Path', 'Trail', 'Beam', 'Map', 'Gate', 'Warp', 'Reflection', 'Specter', 'Spell', 'Rune', 'Soul', 'Body', 'Mind', 'Brain', 'Heart', 'Machine', 'Retina', 'Wave', 'Frequency', 'Impulse', 'Signal', 'Code', 'Algorithm', 'Program', 'Protocol', 'System', 'Circuit', 'Connection', 'Node', 'Network', 'Portal', 'Passage', 'Interface', 'Module', 'Unit', 'Colony', 'Citadel', 'Fortress', 'Labyrinth', 'Meander', 'Abyss', 'Chasm', 'Sky', 'Universe', 'Cosmos', 'Galaxy', 'Nebula', 'Constellation', 'Supernova', 'Black hole', 'Quasar', 'Pulsar', 'Comet', 'Asteroid', 'Moon', 'Sun', 'Planet', 'Satellite', 'Matter', 'Energy', 'Space', 'Time', 'Dimension',];
