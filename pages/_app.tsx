...
const formatCountdown = (seconds: number) => {
  ...
  const generateUserName = () => {
    const adjectives = ['Curious', 'Silent', 'Digital', 'Wise', 'Green', 'Mystic', 'Swift', 'Bright', 'Quantum', 'Cosmic', 'Stellar', 'Deep'];
    const nouns = ['Voyager', 'Phantom', 'Echo', 'Nexus', 'Stream', 'Pixel', 'Orb', 'Drifter', 'Byte', 'Glitch', 'Cipher', 'Vortex'];
